...
class MonnifyController extends Controller
{
    ...
    public function txnCompletion(Request $request): void
    {
        ...
        // Save the webhook data to a JSON log file
        $logFilePath = storage_path('app/webhookx.json');
        $webhookData = json_encode($webHookCall, JSON_PRETTY_PRINT);
        file_put_contents($logFilePath, $webhookData, FILE_APPEND);
