...
class PaymentController extends Controller
{
    ...
    public function deposit()
    {
        ...
        $user = Auth::user();
        $depositSettings = app(FundingSettings::class)->deposit();

        $emptyMessage = 'No history found.';
        $logs = auth()->user()->deposits()->with(['gateway'])->orderBy('id','desc')->paginate(getPaginate());
        return view($this->activeTemplate . 'user.deposit.deposit', compact('logs','emptyMessage','gatewayCurrency', 'pageTitle', 'user', 'depositSettings'));
    }
    ...
    public function depositPreview()
    {
        ...
        return view($this->activeTemplate . 'user.payment.preview', compact('data', 'pageTitle', 'user'));
    }
    ...
    public function manualDepositConfirm()
    {
        ...
        if ($data->method_code > 999) {
            ...
            return view($this->activeTemplate . 'user.manual_payment.manual_confirm', compact('data', 'pageTitle', 'method', 'user'));
        }
        abort(404);
    }
