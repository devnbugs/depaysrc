                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-3 mb-lg-0">
                                    <div class="text-center">
                                        <div class="avatar avatar-xl mb-2">
                                            <img src="{{getImage(imagePath()['withdraw']['method']['path'].'/'. $method->image,imagePath()['withdraw']['method']['size'])}}" alt="avatar" class="img-fluid rounded"/>
                                        </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-lg-4 col-md-6 col-12 mb-3 mb-lg-0">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="currency" class="form-control" value="{{ $method->currency }}"/>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-12 mb-3 mb-lg-0">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="delay" class="form-control" value="{{  $method->delay }}"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-12">
                                    <div class="card border-primary">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                <textarea rows="5" class="form-control nicEdit" name="instruction">{{ $method->description}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
