...
<section class="space-y-6">
    ...
    <section class="panel-card p-6 max-w-2xl">
        <form action="{{ route('pin.set') }}" method="post" class="space-y-6">
            @csrf
