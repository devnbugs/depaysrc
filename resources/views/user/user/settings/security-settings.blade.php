                ...
                @if(auth()->user()->isPinEnabled())
                    ...
                    <div class="grid gap-6 md:grid-cols-2">
                        ...
                        <div class="rounded-3xl border border-slate-200 bg-slate-50/70 p-5 dark:border-white/10 dark:bg-white/5">
                            ...
                            <a href="{{ route('user.pin.change') }}" class="mt-4 inline-flex h-11 items-center rounded-full bg-sky-600 px-6 text-sm font-semibold text-white transition hover:bg-sky-700 dark:bg-sky-500 dark:hover:bg-sky-600">
                                Change PIN
                            </a>
                        </div>
                        ...
                        <div class="rounded-3xl border border-slate-200 bg-slate-50/70 p-5 dark:border-white/10 dark:bg-white/5">
                            ...
                            <a href="{{ route('user.pin.reset') }}" class="mt-4 inline-flex h-11 items-center rounded-full border border-slate-200 bg-white px-6 text-sm font-semibold text-slate-700 transition hover:bg-slate-50 dark:border-white/10 dark:bg-zinc-950 dark:text-zinc-200 dark:hover:bg-white/5">
                                Reset PIN
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="rounded-3xl border border-rose-200 bg-rose-50/60 p-5 dark:border-rose-500/30 dark:bg-rose-500/10">
                        ...
                        <a href="{{ route('user.pin.disable') }}" class="mt-4 inline-flex h-11 items-center rounded-full border border-rose-200 bg-white px-6 text-sm font-semibold text-rose-700 transition hover:bg-rose-50 dark:border-rose-500/30 dark:bg-zinc-950 dark:text-rose-300 dark:hover:bg-rose-500/10">
                            Disable PIN
                        </a>
                    </div>
                @else
                    ...
                    <div class="rounded-3xl border border-slate-200 bg-slate-50/70 p-5 dark:border-white/10 dark:bg-white/5">
                        ...
                        <a href="{{ route('user.pin.setup') }}" class="mt-4 inline-flex h-11 items-center rounded-full bg-sky-600 px-6 text-sm font-semibold text-white transition hover:bg-sky-700 dark:bg-sky-500 dark:hover:bg-sky-600">
                            Setup PIN
                        </a>
                    </div>
                @endif
