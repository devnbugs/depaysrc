...
@section('content')
    <div class="space-y-6 flex flex-col items-center justify-center min-h-screen px-2 sm:px-0">
        <div class="space-y-2">
        ...
        <form method="POST" action="{{ route('user.login') }}" id="auth" class="space-y-5 w-full max-w-md bg-white/90 dark:bg-zinc-900/80 rounded-2xl shadow-lg p-6 sm:p-8" data-busy-form data-busy-message="Signing you in...">
            @csrf
